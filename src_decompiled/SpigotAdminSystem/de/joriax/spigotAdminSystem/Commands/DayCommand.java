...
implements CommandExecutor {
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        Player player;
        if (sender instanceof Player && !(player = (Player)sender).hasPermission("spigot.time.set.day")) {
        ...
        Bukkit.getServer().getWorlds().forEach(world -> world.setTime(1000L));
        sender.sendMessage(SpigotAdminSystem.getPrefix() + "The time was set to day.");
        return true;
    }
}
